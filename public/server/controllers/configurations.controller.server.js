...
module.exports = (app, upload) => {
    ...
    app.get('/api/firmwares/:firmware/configurations', function (req, res) {
        ...
        fs.readdir(`${__dirname}/../configurations/${firmware}`, (err, configurationFiles) => {
    ...
    app.get('/api/firmwares/:firmware/configurations-with-content', function (req, res) {
        const firmware = req.params.firmware
        let configurations = []
        const configurationFiles = fs.readdirSync(`${__dirname}/../configurations/${req.params.firmware}`)
        ...
        configurationFiles.forEach(configurationFile => {
            ...
            const stat = fs.statSync(`${__dirname}/../configurations/${req.params.firmware}/${configurationFile}`)
            if(!stat.isDirectory()) {
                const configurationFileContent = fs.readFileSync(`${__dirname}/../configurations/${req.params.firmware}/${configurationFile}`).toString()
    ...
    app.get('/api/firmwares/:firmware/configurations/:configuration', function (req, res) {
        ...
        const configurationFileContent = fs.readFileSync(`${__dirname}/../configurations/${firmware}/${configuration}`).toString()
    ...
    app.put('/api/firmwares/:firmware/configurations/:configuration', function (req, res) {
        ...
        fs.writeFileSync(`${__dirname}/../configurations/${firmware}/${configuration}`, newConfigurationFileContent)
